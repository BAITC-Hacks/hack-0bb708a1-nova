...
QUESTIONS = {
    ...
    "event_date": "На какую дату планируете? Укажите день, месяц и год.",
    "event_type": "Какое мероприятие планируете?",
    "category": "Кого нужно найти для мероприятия?",
    "budget_kzt": "На какой бюджет в тенге ориентируетесь?",
...
INTRO = "Опишите мероприятие и кого вы ищете."
REDIRECTS = {
